...
상품 사진과 배너는 이미지 모델로 만든 것입니다(실제 상품이 아닙니다). 포장의 우유랩스 로고는 모델이 그린 것이 아니라 **실제 로고 파일을 원근에 맞춰 합성한 것**입니다 — 모델에게 로고를 그리게 하면 모양이 조금씩 달라집니다. 흰 포장에는 밝은 바탕용 로고를, 색 있는 포장(초코·딸기·요거트 통)에는 어두운 바탕용 로고를 썼습니다.
