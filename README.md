...
상품 사진과 배너는 이미지 모델로 만든 것입니다(실제 상품이 아닙니다). 포장의 우유랩스 로고와 제품명은 **로고 파일을 참조로 주고 사진 자체를 생성한 것**입니다 — 찍힌 사진 위에 로고를 합성해 보았더니 조명과 종이 결이 맞지 않아 스티커처럼 떠 보였습니다. 여섯 장이 같은 촬영 세팅이 되도록 첫 장을 나머지의 참조로 썼습니다.
